...
class ContainerShipTest {
    ...
    public void testCreateContainerShip1() {
        ContainerShip containership = new ContainerShip("Marco Polo", LocalDate.of(2012, Month.NOVEMBER, 6), 187625);
    ...
    public void testCreateContainerShip2() {
        ContainerShip containership = new ContainerShip("Hansa Carrier", LocalDate.of(1989, Month.FEBRUARY, 1), 26366);
